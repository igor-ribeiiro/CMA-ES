function xmin=cmaes   % (mu/mu_w, lambda)-CMA-ES
  ...
  while counteval < stopeval
      ...
      [arx, arfitness, counteval, arindex, xmean, ps, pc, C, sigma] = loop_proccessing(lambda, xmean, sigma, B, C, D, N, strfitnessfct, counteval, arx, arfitness, weights, mu, cs, ps, mueff, invsqrtC, chiN, cc, pc, damps, c1, cmu);
